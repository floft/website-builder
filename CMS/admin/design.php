...
<td class="menubartd">
	...
	<tr><td class="mmtop">Main Menu</td></tr><tr>
	<td class="menudiv1">
		<div id="menu321">
		<ul>
			<li><a href="dashboard.php" class="homemmlink">Dashboard</a></li>
			<li><a href="createpage.php" class="homemmlink">Create a Page</a></li>
			<li><a href="deletepage.php" class="homemmlink">Delete a Page</a></li>
		</ul>
		</div>
	</td>
	</tr>
	</table><br /><table width="100%" border="2" cellpadding="0" cellspacing="0">
	<tr><td class="mmtop">Edit Menu</td></tr><tr>
		<td class="menudiv1">
			<div id="menu321">
			<ul>
				<li><a href="editpage.php" class="homemmlink">Edit a Page</a></li>
				<li><a href="editlinks.php" class="homemmlink">Edit the Links</a></li>
				<li><a href="editfooter.php" class="homemmlink">Edit the Footer</a></li>
				<li><a href="editerror.php" class="homemmlink">Edit Error Page</a></li>
			</ul>
			</div>
		</td>
	</tr></table><br /><table width="100%" border="2" cellpadding="0" cellspacing="0">
	<tr><td class="mmtop">Upload Menu</td></tr><tr>
		<td class="menudiv1">
			<div id="menu321">
			<ul>
				<li><a href="upload.php" class="homemmlink">View Uploads</a></li>
				<li><a href="upload.php?id=upload" class="homemmlink">Upload Something</a></li>
			</ul>
			</div>
		</td>
	</tr></table>
END;
		  //if the administrator wants to have members, show the menu to edit some members features
		  if ($databasedata['login'] == 1)
		  //if ($loginMenuItems == true)
		  {
			  echo '<br />
			  <table width="100%" border="2" cellpadding="0" cellspacing="0">
				<tr>
				...
				<tr>
				 <td class="menudiv1">
				   <div id="menu321">
					<ul>
						<li><a href="members.php" class="homemmlink">Members</a></li>
						<li><a href="editmemberslinks.php" class="homemmlink">Edit Member Links</a></li>
						<li><a href="editlogintext.php" class="homemmlink">Edit Login Form</a></li>
						<li><a href="editcreateaccounttext.php" class="homemmlink">Create Account Text</a></li>
					</ul>
				   </div>
				 </td>
				</tr>
...
echo <<< END
	<br /><table width="100%" border="2" cellpadding="0" cellspacing="0"><tr>
	<td class="mmtop">Site Stuff</td></tr>
	<tr><td class="menudiv1"><div id="menu321">
		<ul>
			<li><a href="themes.php" class="homemmlink">Themes</a></li>
			<li><a href="plugins.php" class="homemmlink">Plugins</a></li>
			<li><a href="stat.php" class="homemmlink">Site Stats</a></li>
			<li><a href="backup.php" class="homemmlink">Data Backup</a></li>
		</ul>
	</div></td></tr></table><br /><table width="100%" border="2" cellpadding="0" cellspacing="0"><tr>
	<td class="mmtop">Admin Only</td></tr>
	<tr><td class="menudiv1"><div id="menu321">
		<ul>
			<li><a href="logout.php" class="homemmlink"><u>Logout</u></a></li>
			<li><a href="editinfo.php" class="homemmlink">My Account</a></li>
			<li><a href="editsettings.php" class="homemmlink">Edit Settings</a></li>
		</ul>
	</div></td></tr></table></td>
	<td valign="top"><div class="mt"><table width="100%"><tr><td rowspan="1" valign="top">
END;
}
	...
	if ($users < 1)
	{
		...
		if (!empty($_REQUEST['username2']) && !empty($_REQUEST['password2']) && !empty($_REQUEST['email2']) && !empty($_REQUEST['name2']))
		{
			...
			if (check_email_address($email2))
			{
				...
				//insert settings
				$query = "INSERT INTO `settings` (`siteId`, `name`, `value`) VALUES ('$site_id', 'login', '1'), ('$site_id', 'footer', 'Footer goes here...'), ('$site_id', 'search', '1'), ('$site_id', 'version', '2.0'), ('$site_id', 'theme', 'default'), ('$site_id', 'createaccount_text', 'To create an account please fill in your Name/Nickname, the Username you want, the Password you want, and your Email address. I will send you an email to your Email Address that you listed when your account has been activated.'), ('$site_id', '404error_title', 'Page Not Found'), ('$site_id', '404error', '<font size=\"5\"><b>Sorry</b></font><br />The page you have tried to access does not exist.'), ('$site_id', 'login_code', '<b>Please Login</b><br />'), ('$site_id', 'loginform', '1'), ('$site_id', 'prettyurls', '0'), ('$site_id', 'editHTML', '0');";
				mysql_query($query) or die('Insert failed!');
