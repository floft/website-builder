...
site_header("Edit Create Account Text");
...
if (isset($_POST['contents']))
{
	...
	$query = "Update `settings` Set value = '$contents' where name = 'createaccount_text' and siteId = '$site_id'";
	$result = mysql_query($query) or die ('Putting data into database failed!');

	echo '<font class="c595">Create Account Text</font><br />Click <a href="editcreateaccounttext.php">Here</a> to continue editing.';
	echo '<script type="text/javascript">window.top.location="editcreateaccounttext.php";</script>';
}
else
{
	$edit = $_REQUEST['edit'];
	...
	if ($databasedata['prettyurls']==1) echo '<font class="c595">Edit Create Account Text</font><br /><a href="../create" target="_blank">View Page</a><br />';
	else echo '<font class="c595">Edit Create Account Text</font><br /><a href="../index.php?id=create" target="_blank">View Page</a><br />';
	...
	echo '<form method="post" action="editcreateaccounttext.php">
